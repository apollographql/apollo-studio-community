...
| What's new | |
| :--------- | :-: |
| Federation 2 is entering General Availability! We've updated the new graph on-boarding experience to have a fresh new look, and now federation 2 is the default on-boarding experience. There is no impact to existing graphs with this update. | ![image](https://user-images.githubusercontent.com/6365997/162784055-ec577ae6-18ff-4719-b1e1-3602362198e2.png) |
