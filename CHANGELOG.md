...
| Additionally, the Insights page now has **Fast Mode** time range options. These options exclude the last 24 hours of data to help increase load times for large graphs. |![image](https://github.com/apollographql/apollo-studio-community/assets/9286598/ecd233c5-8fac-48db-a0d2-c1f4dce3c3a5) |
